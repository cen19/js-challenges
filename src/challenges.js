...
// DECSRIPTION: Write a function that checks if a number is multiple of another number.
...
// DECSRIPTION: Write a function that returns the longest word of a sentence.
...
// DECSRIPTION: Write a function that capitalize each word in a sentence.
// Ex: capitalize('hello world') => 'Hello World'
module.exports.capitalize = function(str) {};


// CHALLENGE 10: VOWEL COUNT
// DECSRIPTION: Write a function that count vowel in a sentence.
// Ex: vowelCount('fox') => 1
